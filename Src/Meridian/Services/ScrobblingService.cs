...
namespace Meridian.Services
{
    public class ScrobblingService
    {
        ...
        public async Task<bool> Scrobble(IAudio audio)
        {
            ...
            await _lastFm.Track.Scrobble(audio.Artist, audio.Title, 
                time.ToString(), null, (int)audio.Duration.TotalSeconds);
        ...
        {
            await _lastFm.Track.UpdateNowPlaying(audio.Artist, 
                audio.Title, null, (int)audio.Duration.TotalSeconds);
